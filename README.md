...
## v0.4.7
- Виправлено видимість direct-повідомлень для одержувача.
- Додано SQL `supabase-direct-chat-visibility-v047.sql`.
- Realtime тепер фільтрує діалог у клієнті, щоб повідомлення приходили обом сторонам.
